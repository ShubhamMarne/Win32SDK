...
LRESULT CALLBACK WndProc(HWND hwnd, UINT iMsg, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_CREATE:
		...
		if (hThread1 == NULL)
		{
			MessageBox(hwnd, TEXT("Error..."), TEXT("Message"), MB_OK);
		}
	...
	case WM_LBUTTONDOWN:
		MessageBox(hwnd, TEXT("Left button clicked..."), TEXT("Message"), MB_OK);
		break;
...
DWORD WINAPI MyThreadProcOne(LPVOID param)
{
	...
	{
		wsprintf(str, TEXT("Thread 1 : Increasing Number= %d"), i);
...
DWORD WINAPI MyThreadProcTwo(LPVOID param)
{
	...
	{
		wsprintf(str, TEXT("Thread 2 : Decreasing Number = %d"), i);
